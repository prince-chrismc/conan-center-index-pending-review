...
func TestGetReviewSummary16144(t *testing.T) {
	...
	assert.Equal(t, &PullRequestSummary{
		...
		Summary: Reviews{Count: 2, ValidApprovals: 2, TeamApproval: true, Approvals: []Approver{Approver{Name: "toge", Tier: Community}, Approver{Name: "prince-chrismc", Tier: Community},},
